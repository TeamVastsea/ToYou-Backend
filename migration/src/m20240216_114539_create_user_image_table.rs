        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(UserImage::Id).big_integer().not_null().auto_increment().primary_key())
                    .col(ColumnDef::new(UserImage::ImageId).string().not_null())
                    .col(ColumnDef::new(UserImage::UserId).big_integer().not_null())
                    .col(ColumnDef::new(UserImage::FileName).string().not_null())
                    .col(ColumnDef::new(UserImage::FolderId).big_integer().not_null())

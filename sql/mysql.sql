...
(
    prid BIGINT AUTO_INCREMENT NOT NULL COMMENT 'prid' PRIMARY KEY,
    uid BIGINT NOT NULL COMMENT '拥有者uid',
    child TEXT COMMENT '子项目',
    parent TEXT DEFAULT NULL COMMENT '父项目',
